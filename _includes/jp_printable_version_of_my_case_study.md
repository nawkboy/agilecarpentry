# 私のLeSS事例研究の印刷可能バージョン

[LeSS事例研究のオンライン版](https://less.works/case-studies/large-server-hardware-company){:target="_blank"}は印刷に適していない場合があります。以下のPDFバージョンは印刷用に明示的にフォーマットされています。

* [事例研究全文、英語、レター、PDF]({{site.url}}{{site.baseurl}}/assets/pdfs/case-study/large-server-hardware-company.pdf){:target="_blank"}
...
事例研究の完全版を英語と日本語でAmazonにて自費出版しています。豪華な表紙を除き、Amazon印刷版の内容は上記のレターサイズ自己印刷版と同一です。Amazonで印刷する方が、特に無料配送を利用した場合、家庭用プリンターで印刷するよりも割安になることが多いです。

標準カラー内装版（低価格）はほとんどの国で購入可能ですが、一部の国では取り扱いがありません。標準カラー内装版が利用できない場合は、プレミアムカラー内装版（高価格）が一般的に購入可能です。標準カラー版が利用可能な場合は、そちらをお勧めします。
...
# 私のLeSS事例研究のIngramSpark印刷版

本事例研究はIngramSparkでも配布されています。そのため、世界中の実店舗書店でカスタム注文が可能です。IngramSpark配布版のISBNは、英語版が978-1-7328751-5-9、日本語翻訳版が978-1-7328751-6-6です。以下の大手オンライン書店ではオンライン在庫として掲載されています。

### 英語、ISBN 978-1-7328751-5-9
...
日本語翻訳版は2026年4月16日に出版申請を行いました。入稿前チェックが順調に進めば、IngramSpark配布版が各オンライン書店のデータベースに反映されるまでには数週間かかる見込みです。反映され次第、Honto、楽天ブックス、紀伊國屋書店のリンクを更新する予定です。